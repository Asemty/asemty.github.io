(function(data){
	...
	[
		[
			{name: "9999999 in 1", discription: "Четыре завершённых игры, один интересный тест", imgSrc: "img/tetris.png", htmlSrc: "games/TetriScript/game.html"},
			{name: "Pather", discription: "Графический редактор патернов", imgSrc: "img/pather.png", htmlSrc: "games/Pather/game.html"},
			{name: "Jafer Strike", discription: "Платформер с 7 видами оружия и 1 боссом", imgSrc: "img/Jafer Strike.png", htmlSrc: "games/Jafer Strike/game.html"}
		],
		[
