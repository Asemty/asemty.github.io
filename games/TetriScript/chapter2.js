class Genetic extends Part{
	...
	start(){
		alert("Симулятор эволюции с вмешательством.\nУправление: влево(красный)/вниз(зелёный)/вправо(синий) задают цвет-условие для отбора. Вверх - сброс условий\nЕсли задать жёсткое условие при низкой популяции - все вымрут.\nЕсли вводить постепенно - выжившие адаптируются");
		this.cells=[];
		var startNumber=50;
